...
interface SheetContentProps
  ...
  /** Esconde o fundo escuro — use com <Sheet modal={false}> para deixar o
   *  resto da página utilizável enquanto o painel está aberto. */
  semOverlay?: boolean
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = 'right', className, children, semOverlay, ...props }, ref) => (
  <SheetPortal>
    {!semOverlay && <SheetOverlay />}
